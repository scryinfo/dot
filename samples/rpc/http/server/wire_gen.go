...
func InitializeService() (*Line, func(), error) {
	...
	httpServerConfig := &lineConfig.Connect
	handlerMiddle := rpcdot.NewHandlerMiddle()
	connectHttpServer, cleanup, err := rpcdot.NewConnetHttpServer(httpServerConfig, connectHttpServerMux, logger, handlerMiddle)
	if err != nil {
		return nil, nil, err
	}
	line := &Line{
