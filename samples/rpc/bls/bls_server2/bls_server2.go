...
type LineConfig struct {
	...
	ConnectServerEtcd rpcdot.ConnectServerEtcdConfig `json:"connect_server_etcd" toml:"connect_server_etcd" yaml:"connect_server_etcd" mapstructure:"connect_server_etcd"`
