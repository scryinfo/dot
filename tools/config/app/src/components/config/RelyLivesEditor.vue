<template>
    <div>
        <el-row>
            ...
            <el-col :span="3">
                <json-rely-button :objc="parsedData" v-model="parsedData"></json-rely-button>
            </el-col>
        </el-row>
        <el-row v-for="(ob,index) in parsedData" v-model="parsedData">
            <el-col :span="6" :offset="2">
                <el-input type="text" v-model="ob.name"></el-input>
            </el-col>
            <el-col :span="2">
      ...
      <span class="el-dropdown-link" style="text-align: center;line-height: 46px;">
            ...
            <el-col :span="10">
                <el-input type="text" v-model="ob.remark"></el-input>
            </el-col>
            <el-col :span="3">
