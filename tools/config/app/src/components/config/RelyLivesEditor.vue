<template>
    <div>
        ...
        <el-row v-for="(ob,index) in parsedData" v-model="parsedData"><el-col :span="6" :offset="2"><el-input type="text" v-model="ob.name"></el-input></el-col><el-col :span="2"><el-dropdown trigger="click">
      <span class="el-dropdown-link" style="text-align: center;line-height: 46px;">
        ...
        </el-dropdown></el-col><el-col :span="10"><el-input type="text" v-model="ob.remark"></el-input></el-col><el-col :span="3"><el-button @click="removeObject(index)">remove</el-button></el-col></el-row>
    </div>
</template>
