                            ...
                            <el-col :span="17">
                                <el-collapse-item v-bind:title="live.liveId" v-bind:name="index+' '+index2">
                                    <el-row>
                                        ...
                                        <el-col :span="15">
                                            <el-input type="text" v-model="live.name" placeholder="Name"></el-input>
                                        </el-col>
                                    </el-row>
                                    <el-row>
                                        <el-col :span="2"><label>liveId</label></el-col>
                                        <el-col :span="15">
                                            <el-input type="text" v-model="live.liveId" placeholder="LiveId"></el-input>
                                        </el-col>
                                        <el-col :span="4">
                                    ...
                                    <el-row v-if="live.json">
                                        ...
                                        <el-col :span="4">
                                            <json-button :objc="live.json" v-model="live.json"></json-button>
                                        </el-col>
                                    </el-row>
                                </el-collapse-item>
                            </el-col>
                            <el-col :span="2">
                                <json-button :objc="config.lives[index2]" v-model="config.lives[index2]"></json-button>
                            </el-col>
                            <el-col :span="3">
