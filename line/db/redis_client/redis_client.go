...
type RedisConfig struct {
	...
	KeepMaxVersionCount int64  `json:"keep_max_version_count" toml:"keep_max_version_count" yaml:"keep_max_version_count" mapstructure:"keep_max_version_count"` //分类中版本的最大数据量
