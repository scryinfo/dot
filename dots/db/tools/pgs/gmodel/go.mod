module github.com/scryinfo/dot/dots/db/tools-pgs/gmodel

go 1.18

require (
	github.com/jinzhu/inflection v1.0.0
	github.com/scryinfo/dot v0.3.3-0.20221018024033-60ed0a044bb1
...
require (
	...
	github.com/scryinfo/scryg v0.1.3 // indirect
